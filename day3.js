...
function linesIntersect(segment1, segment2) {
  ...
  return getIntersections(segment1, segment2);
}

function getIntersections(segment1, segment2) {
  const intersections = [];
  segment1 = [startX1, startY1, endX1, endY1];
  segment2 = [startX2, startY2, endX2, endY2];
  ...
  console.log(segment1, segment2, intersections);
